  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafaf8" }}>
      ...
      <div style={{ padding: "0 28px 100px" }}>
        ...
        {step === "rate" && (
          <div>
            <p style={{ fontFamily: "cursive", fontSize: 15, color: "#888", margin: "0 0 4px" }}>step four</p>
        ...
        {step === "context" && (
          <div>
            <p style={{ fontFamily: "cursive", fontSize: 15, color: "#888", margin: "0 0 4px" }}>step five</p>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <textarea value={note} onChange={e => setNote(e.target.value)} placeholder="anything else worth noting..."
                style={{ width: "100%", fontFamily: "cursive", fontSize: 17, border: "1px solid #e8e8e4", borderRadius: 10, padding: "14px", background: "transparent", color: "#1a1a1a", outline: "none", resize: "none", height: 80 }} />
            </div>
