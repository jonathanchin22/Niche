  ...
  return (
    <AppShell>
      ...
      <section style={{ display: "flex", flexDirection: "column", gap: 10, padding: "24px 24px 0" }}>
        {place.city && <span className="t-label">shop · {place.city}</span>}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 10, padding: "22px 24px 0" }}>
        <Link href={`/log?place=${place.id}`} className="btn btn-primary" style={{ padding: 0 }}><PlusIcon size={14} />log a drink here</Link>
