...
const PUBLIC_ROUTES = ["/auth/login", "/auth/signup", "/auth/callback", "/join", "/privacy", "/terms"]
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.svg|manifest.json|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"],
}
